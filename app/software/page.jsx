...
const DEMO_RISK = {
  t0: {title:"Kickoff & Plan is the root dependency",  blurb:"Every other task waits on this. A slip here pushes the entire 41-day plan back day-for-day.",           delay:"+1d per 1d slip", blocked:"8 tasks", owners:"4 owners", cost:"$1,400/day",  fix:{title:"No slack to protect — lock scope before day 1", blurb:"This task can't safely run long. Freeze requirements before kickoff starts.", confidence:74}},
  ...
  t5: {title:"Development is the bottleneck",           blurb:"QA & Testing can't start until it's done. 2 days of buffer remain on the critical path.",                delay:"+5–7d",           blocked:"2 tasks", owners:"2 owners", cost:"$4,200",      fix:{title:"Run Product Photos in parallel", blurb:"Already true in this plan — helps absorb slips upstream of Development.", confidence:86}},
